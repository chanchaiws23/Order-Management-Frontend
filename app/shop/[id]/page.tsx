    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="relative aspect-square overflow-hidden rounded-lg bg-gray-100">
          ...
          />
          {product.isFeatured && (
            <div className="absolute left-4 top-4 rounded-md bg-primary px-3 py-1 text-sm font-medium text-white">
              Featured
            </div>
          )}
            ...
            <CardContent className="p-4">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={`font-medium ${product.stockQuantity > 0 ? 'text-green-600' : 'text-red-600'}`}
                  >
                    {product.stockQuantity > 0
      ...
      {product.images && product.images.length > 0 && (
        <div className="mt-12">
          <h2 className="mb-6 text-2xl font-bold">More Images</h2>
